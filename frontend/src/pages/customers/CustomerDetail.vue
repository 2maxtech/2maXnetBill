...
async function handleDelete() {
  ...
  try {
    await deleteCustomer(customerId, deletePassword.value)
      ...
      <div class="space-y-4">
        <div class="rounded-lg bg-red-50 border border-red-200 px-4 py-3">
          <p class="text-sm text-red-700">
            This will <strong>permanently delete {{ customer?.full_name }}</strong> and remove the PPPoE secret from MikroTik. All invoices, payments, and records will be lost. This cannot be undone.
          </p>
        </div>
