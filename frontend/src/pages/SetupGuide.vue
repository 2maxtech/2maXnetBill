...
const steps = [
  {
    ...
    content: [
      ...
      { type: 'steps', value: [
        ...
        'Step 1: Copy the generated MikroTik script',
        'Open WinBox Terminal (or SSH) on your MikroTik and paste the script — this creates the WireGuard interface and adds the NetLedger server as a peer',
        'Step 2: On your MikroTik, run /interface/wireguard/print and copy the Public Key shown',
      ...
      { type: 'steps', value: [
        'After activation, your router should show a green "Connected" badge on the Routers page',
        'NetLedger now communicates with your MikroTik through the encrypted WireGuard tunnel',
        'All management (customer provisioning, bandwidth changes, disconnects) works through this tunnel',
      ]},
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'steps', value: [
        ...
        'Name: pppoe-pool',
        'Addresses: 172.16.0.2-172.16.0.254 (or your preferred private range)',
        'Click OK',
      ]},
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'steps', value: [
        ...
        'NetLedger previews all existing profiles with their speeds and customer counts',
        'Set the monthly price for each plan before importing',
        'Click Import — NetLedger creates Plans and Customers from your existing PPPoE secrets',
      ]},
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'steps', value: [
        'Overdue invoices are detected automatically by the system',
        'Graduated enforcement kicks in based on your Settings → Billing configuration',
        'Default: Throttle at 3 days overdue, Disconnect at 5 days overdue',
        'When customer pays, service is restored automatically — no manual reconnect needed',
